...
- filename: sinch-applications-api-openapi.yml
  ...
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-applications-api-openapi.yml
- filename: sinch-apps-api-openapi.yml
  format: yaml
  label: Sinch Apps API
  slug: sinch-apps-api
  spec_type: OpenAPI
...
- filename: sinch-available-numbers-api-openapi.yml
  ...
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-available-numbers-api-openapi.yml
- filename: sinch-available-regions-api-openapi.yml
  format: yaml
  label: Sinch Available Regions API
...
- filename: sinch-callouts-api-openapi.yml
  ...
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-callouts-api-openapi.yml
- filename: sinch-calls-api-openapi.yml
  format: yaml
  label: Sinch Calls API
...
- filename: sinch-capability-api-openapi.yml
  ...
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-capability-api-openapi.yml
- filename: sinch-conferences-api-openapi.yml
  format: yaml
  label: Sinch Conferences API
...
- filename: sinch-contacts-api-openapi.yml
  ...
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-contacts-api-openapi.yml
- filename: sinch-conversations-api-openapi.yml
  format: yaml
  label: Sinch Conversations API
...
- filename: sinch-events-api-openapi.yml
  ...
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-events-api-openapi.yml
- filename: sinch-fax-to-email-api-openapi.yml
  format: yaml
  label: Sinch Fax to Email API
  slug: sinch-fax-to-email-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-fax-to-email-api-openapi.yml
- filename: sinch-faxes-api-openapi.yml
  format: yaml
  label: Sinch Faxes API
...
- filename: sinch-line-senders-api-openapi.yml
  ...
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-line-senders-api-openapi.yml
- filename: sinch-market-requirements-api-openapi.yml
  format: yaml
  label: Sinch Market Requirements API
  slug: sinch-market-requirements-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-market-requirements-api-openapi.yml
- filename: sinch-messages-api-openapi.yml
  format: yaml
  label: Sinch Messages API
...
- filename: sinch-rcs-senders-api-openapi.yml
  ...
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-rcs-senders-api-openapi.yml
- filename: sinch-registrations-api-openapi.yml
  format: yaml
  label: Sinch Registrations API
...
- filename: sinch-sip-endpoints-api-openapi.yml
  ...
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/openapi/sinch-sip-endpoints-api-openapi.yml
- filename: sinch-sip-trunks-api-openapi.yml
  format: yaml
  label: Sinch SIP Trunks API
