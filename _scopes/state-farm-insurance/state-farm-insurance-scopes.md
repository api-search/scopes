...
note: ''
overview: 'State Farm Insurance publishes 3 OAuth 2.0 scopes via the clientCredentials flow. Scopes are the fine-grained permissions an application requests at authorization time to act against the State Farm Insurance API on a user''s behalf.
...
source_filename: state-farm-insurance-scopes.yml
source_heading: OAuth Scopes
source_url: ''
source_yaml: "generated: '2026-07-11'\nmethod: derived\nsource: openapi/state-farm-insurance-renters-openapi.yml\nschemes:\n- name: OAuth2\n  source: openapi/state-farm-insurance-renters-openapi.yml\n  flows:\n  - flow: clientCredentials\n    tokenUrl: https://api.statefarm.com/oauth/token\nscopes:\n- scope: renters:policy:read\n  description: Read renters insurance policy details\n  flows:\n  - clientCredentials\n  sources:\n  - openapi/state-farm-insurance-renters-openapi.yml\n- scope: renters:policy:write\n  description: Bind and manage renters insurance policies\n  flows:\n  - clientCredentials\n  sources:\n  - openapi/state-farm-insurance-renters-openapi.yml\n- scope: renters:quote\n  description: Create and retrieve renters insurance quotes\n  flows:\n  - clientCredentials\n  sources:\n  - openapi/state-farm-insurance-renters-openapi.yml\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/state-farm-insurance/refs/heads/main/scopes/state-farm-insurance-scopes.yml
