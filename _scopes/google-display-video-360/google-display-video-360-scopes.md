...
note: ''
overview: 'Google Display & Video 360 publishes 1 OAuth 2.0 scope via the authorizationCode flow. Scopes are the fine-grained permissions an application requests at authorization time to act against the Google Display & Video 360 API on a user''s behalf.
...
scopes:
- description: Manage Display & Video 360 data
  flows:
  - authorizationCode
