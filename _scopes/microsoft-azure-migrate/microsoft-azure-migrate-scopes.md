...
note: ''
overview: 'Azure Migrate publishes 1 OAuth 2.0 scope via the implicit flow. Scopes are the fine-grained permissions an application requests at authorization time to act against the Azure Migrate API on a user''s behalf.
...
source_filename: microsoft-azure-migrate-scopes.yml
