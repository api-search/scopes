...
note: ''
overview: 'Google Indexing publishes 1 OAuth 2.0 scope via the authorizationCode flow. Scopes are the fine-grained permissions an application requests at authorization time to act against the Google Indexing API on a user''s behalf.
...
scopes:
- description: Submit URLs to Google indexing
  flows:
  - authorizationCode
