...
overview: 'Pacific Gas and Electric publishes 21 OAuth 2.0 scopes via the authorization_code, client_credentials, and refresh_token flows. Scopes are the fine-grained permissions an application requests at authorization time to act against the Pacific Gas and Electric API on a user''s behalf.
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/pge/refs/heads/main/scopes/pg-and-e-scopes.yml
