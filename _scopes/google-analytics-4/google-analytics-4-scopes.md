---
api_specs:
- filename: google-analytics-4-v1beta-api-openapi.yml
  format: yaml
  label: Google Analytics 4 V1beta API
  slug: google-analytics-4-v1beta-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/google-analytics-4/refs/heads/main/openapi/google-analytics-4-v1beta-api-openapi.yml
authorization_urls:
