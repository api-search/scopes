...
note: ''
overview: 'microsoft-azure-databricks publishes 1 OAuth 2.0 scope via the authorizationCode flow. Scopes are the fine-grained permissions an application requests at authorization time to act against the microsoft-azure-databricks API on a user''s behalf.
...
provider_name: microsoft-azure-databricks
...
source_filename: microsoft-azure-databricks-scopes.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/microsoft-azure-databricks/refs/heads/main/scopes/microsoft-azure-databricks-scopes.yml
