...
- filename: payt-payment-conditions-api-openapi.yml
  format: yaml
  label: Payt Payment Conditions API
...
- filename: payt-psp-transactions-api-openapi.yml
  format: yaml
  label: Payt Psp Transactions API
