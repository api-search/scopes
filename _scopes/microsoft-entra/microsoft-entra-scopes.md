---
api_specs:
- filename: microsoft-entra-applications-api-openapi.yml
  format: yaml
  label: Microsoft Entra Applications API
...
- filename: microsoft-entra-groups-api-openapi.yml
  format: yaml
  label: Microsoft Entra Groups API
