...
- filename: newstore-easypostadapterconfig-api-openapi.yml
  format: yaml
  label: Newstore EasypostAdapterConfig API
...
- filename: newstore-import-schemas-api-openapi.yml
  format: yaml
  label: Newstore Import Schemas API
  slug: newstore-import-schemas-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/newstore/refs/heads/main/openapi/newstore-import-schemas-api-openapi.yml
- filename: newstore-inventory-configuration-api-openapi.yml
  format: yaml
  label: Newstore Inventory Configuration API
...
- filename: newstore-pricebook-export-api-openapi.yml
  format: yaml
  label: Newstore Pricebook export API
  slug: newstore-pricebook-export-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/newstore/refs/heads/main/openapi/newstore-pricebook-export-api-openapi.yml
- filename: newstore-product-export-api-openapi.yml
  format: yaml
  label: Newstore Product export API
...
- filename: newstore-reason-codes-api-openapi.yml
  format: yaml
  label: Newstore Reason Codes API
