...
note: ''
overview: 'Khoros publishes 1 OAuth 2.0 scope via the clientCredentials and authorizationCode flows. Scopes are the fine-grained permissions an application requests at authorization time to act against the Khoros API on a user''s behalf.
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/khoros-ai/refs/heads/main/scopes/lithium-scopes.yml
