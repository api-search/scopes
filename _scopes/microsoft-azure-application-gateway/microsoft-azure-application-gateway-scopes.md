...
note: ''
overview: 'Azure Application Gateway publishes 1 OAuth 2.0 scope via the implicit flow. Scopes are the fine-grained permissions an application requests at authorization time to act against the Azure Application Gateway API on a user''s behalf.


  This index is generated from the provider''s OpenAPI security definitions (and, where available, its documented scope reference) and refreshes on every APIs.io network build. Browse every provider''s scopes at [scopes.apis.io](https://apis.io/scopes/).'
provider_name: Azure Application Gateway
provider_slug: microsoft-azure-application-gateway
schemes:
- description: Azure Active Directory OAuth2 Flow.
  ...
  - authorizationUrl: https://login.microsoftonline.com/common/oauth2/authorize
    flow: implicit
  name: azure_auth
  source: openapi/microsoft-azure-application-gateway-openapi.yml
scope_count: 1
scope_names:
- user_impersonation
scopes:
...
source_filename: microsoft-azure-application-gateway-scopes.yml
source_heading: OAuth Scopes
source_url: ''
source_yaml: "generated: '2026-07-11'\nmethod: derived\nsource: openapi/microsoft-azure-application-gateway-openapi.yml\nschemes:\n- name: azure_auth\n  source: openapi/microsoft-azure-application-gateway-openapi.yml\n  flows:\n  - flow: implicit\n    authorizationUrl: https://login.microsoftonline.com/common/oauth2/authorize\n  description: Azure Active Directory OAuth2 Flow.\nscopes:\n- scope: user_impersonation\n  description: Impersonate your user account\n  flows:\n  - implicit\n  sources:\n  - openapi/microsoft-azure-application-gateway-openapi.yml\n"
