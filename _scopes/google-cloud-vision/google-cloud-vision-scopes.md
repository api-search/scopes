---
api_specs:
- filename: google-cloud-vision-files-api-openapi.yml
  format: yaml
  label: Google Cloud Vision Files API
  slug: google-cloud-vision-files-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/google-cloud-vision/refs/heads/main/openapi/google-cloud-vision-files-api-openapi.yml
- filename: google-cloud-vision-images-api-openapi.yml
  format: yaml
  label: Google Cloud Vision Images API
...
note: ''
overview: 'Google Cloud Vision publishes 2 OAuth 2.0 scopes via the authorizationCode flow. Scopes are the fine-grained permissions an application requests at authorization time to act against the Google Cloud Vision API on a user''s behalf.
...
- description: Manage your Google Cloud Vision resources
  flows:
  - authorizationCode
  scope: https://www.googleapis.com/auth/cloud-vision
slug: google-cloud-vision-scopes
source_filename: google-cloud-vision-scopes.yml
