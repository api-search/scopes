...
note: ''
overview: 'Chase UK publishes 3 OAuth 2.0 scopes via the clientCredentials and authorizationCode flows. Scopes are the fine-grained permissions an application requests at authorization time to act against the Chase UK API on a user''s behalf.
...
source_filename: chase-uk-scopes.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/chase-uk/refs/heads/main/scopes/chase-uk-scopes.yml
