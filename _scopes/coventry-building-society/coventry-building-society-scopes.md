...
note: ''
overview: 'Coventry Building Society publishes 3 OAuth 2.0 scopes via the clientCredentials and authorizationCode flows. Scopes are the fine-grained permissions an application requests at authorization time to act against the Coventry Building Society API on a user''s behalf.
...
source_filename: coventry-building-society-scopes.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/coventry-building-society/refs/heads/main/scopes/coventry-building-society-scopes.yml
