...
note: ''
overview: 'Bloomreach publishes 3 OAuth 2.0 scopes via the authorizationCode flow. Scopes are the fine-grained permissions an application requests at authorization time to act against the Bloomreach API on a user''s behalf.
...
source_filename: bloomreach-scopes.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/bloomreach/refs/heads/main/scopes/bloomreach-scopes.yml
